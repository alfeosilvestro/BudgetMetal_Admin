...
function sendRequest() {
    ...
    var s = escape(document.getElementById("subject").value);
    var body = document.getElementById("body").value;

    var ajaxurl = document.getElementById("contacturl").value;
    ...
    //    url: ajaxurl,
    //    type: 'post',
    //    data: { senderEmail: email, senderName: name, subject: s, content: body },
    //        dataType: 'json',
    ...
    try {
        ...
        http.send('senderEmail=' + email + '&senderName=' + name + '&subject=' + s + '&content=' + body );
    }
    catch (e) { }
    finally {
        jQuery('#contactform').slideUp("slow").hide();
