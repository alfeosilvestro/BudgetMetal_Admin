...
namespace Com.BudgetMetal.DataRepository.RFQ
{
    public interface IRfqRepository : IGenericRepository<Com.BudgetMetal.DBEntities.Rfq>
    {
        ...
        Task<PageResult<Com.BudgetMetal.DBEntities.Rfq>> GetRfqTemplateByPage(int userId, int documentOwner, int page, int totalRecords, bool isCompany, int statusId, string keyword);
